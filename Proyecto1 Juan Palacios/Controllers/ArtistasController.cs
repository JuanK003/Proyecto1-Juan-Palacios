...
namespace Proyecto1_Juan_Palacios.Controllers
{
    public class ArtistasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Artista,NombreArtista,EmailArtista")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Artista,NombreArtista,EmailArtista")] Artista artista)
        {
            if (ModelState.IsValid)
            {
